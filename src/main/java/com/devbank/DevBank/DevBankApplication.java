...
public class DevBankApplication {
    ...
    public static void main(String[] args) {
        ...
        System.setProperty("spring.frontend.url", dotenv.get("FRONTEND_URL"));
        System.setProperty("api.gemini.token", dotenv.get("GEMINI_KEY"));
        if ("prod".equals(dotenv.get("SPRING_PROFILES_ACTIVE"))) {
